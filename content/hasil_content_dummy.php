							...
							<div class="col-md-4" style="margin-bottom: 0">
								<div class="media">
									...
									<div class="media-body">
										...
										<h5 style="font-weight:normal">Kebun Percobaan IPB-Cargill</h5>
									</div>
								</div>
							</div>
							<div class="col-md-4" style="margin-bottom: 0">
								<div class="media">
									...
									<div class="media-body">
										...
										<h5 style="font-weight:normal">25 Mei 2017</h5>
							...
							<div class="col-md-4" style="margin-bottom: 0">
								<div class="media">
									...
									<div class="media-body">
										...
										<h5 style="font-weight:normal">56 Ha</h5>
						...
						<div class="row clearfix">
							<div class="col-lg-6" style="margin-bottom:0">
								<div class="panel panel-success">
									...
									<div class="panel-body" style="padding:0">
										...
										<select id="cbunsur">
											...
											<option value="P">Phosphor</option>
								...
								<ul class="list-group" id="legend_P" style="border: 1px solid #ddd;margin-bottom:0;display:none;">
									<li class="list-group-item" style="padding: 5px 15px; border: none;">
										<span style="width:25px;display:inline-block;background:#FF0000;margin-right:25px;">&nbsp;</span> &lt;= 0.09 ppm</li>
									<li class="list-group-item" style="padding: 5px 15px; border: none;">
										<span style="width:25px;display:inline-block;background:#FCFF2D;margin-right:25px;">&nbsp;</span> 0.09 ppm - 0.11 ppm</li>
									<li class="list-group-item" style="padding: 5px 15px; border: none;">
										<span style="width:25px;display:inline-block;background:#6AFE48;margin-right:25px;">&nbsp;</span> 0.11 ppm - 0.13 ppm</li>
									<li class="list-group-item" style="padding: 5px 15px; border: none;">
										<span style="width:25px;display:inline-block;background:#02C630;margin-right:25px;">&nbsp;</span> 0.13 ppm - 0.15 ppm</li>
									<li class="list-group-item" style="padding: 5px 15px; border: none;">
										<span style="width:25px;display:inline-block;background:#20E6DC;margin-right:25px;">&nbsp;</span> 0.15 ppm - 0.17 ppm</li>
									<li class="list-group-item" style="padding: 5px 15px; border: none;">
										<span style="width:25px;display:inline-block;background:#123A8F;margin-right:25px;">&nbsp;</span> &gt; 0.17 ppm</li>
								</ul>							
								<ul class="list-group" id="legend_K" style="border: 1px solid #ddd;margin-bottom:0;display:none;">
									<li class="list-group-item" style="padding: 5px 15px; border: none;">
										<span style="width:25px;display:inline-block;background:#FF0000;margin-right:25px;">&nbsp;</span> &lt;= 0.4 ppm</li>
									<li class="list-group-item" style="padding: 5px 15px; border: none;">
										<span style="width:25px;display:inline-block;background:#FCFF2D;margin-right:25px;">&nbsp;</span> 0.4 ppm - 0.6 ppm</li>
									<li class="list-group-item" style="padding: 5px 15px; border: none;">
										<span style="width:25px;display:inline-block;background:#6AFE48;margin-right:25px;">&nbsp;</span> 0.6 ppm - 0.8 ppm</li>
									<li class="list-group-item" style="padding: 5px 15px; border: none;">
										<span style="width:25px;display:inline-block;background:#02C630;margin-right:25px;">&nbsp;</span> 0.8 ppm - 1.0 ppm</li>
									<li class="list-group-item" style="padding: 5px 15px; border: none;">
										<span style="width:25px;display:inline-block;background:#20E6DC;margin-right:25px;">&nbsp;</span> 1.0 ppm - 1.2 ppm</li>
									<li class="list-group-item" style="padding: 5px 15px; border: none;">
										<span style="width:25px;display:inline-block;background:#123A8F;margin-right:25px;">&nbsp;</span> &gt; 1.2 ppm</li>
								</ul>							
							</div>
							<div class="col-lg-6" style="margin-bottom:0">
								<div class="panel panel-success">
